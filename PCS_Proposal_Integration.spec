...
a = Analysis(
    [str(project_dir / "run_integration_app.py")],
...
app = BUNDLE(
    coll,
    name="PCS_Proposal_Integration.app",
    icon=str(icon_path),
    bundle_identifier="com.procoatingsystems.pcsproposal.integration",
    info_plist={
        "CFBundleDisplayName": "PCS Proposal Integration",
        "CFBundleName": "PCS Proposal Integration",
