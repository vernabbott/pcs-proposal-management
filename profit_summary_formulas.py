...
PS_F_D18 = '=IF(C18<>"",IF(H3="Gaco",Data!N15,IF(H3="Uniflex",Data!N16,0)),0)'
PS_F_E18 = '=IF(C18<>"",C18*D18,0)'
PS_F_H18 = '=C18'
PS_F_I18 = '=D18'
PS_F_K18 = '=IF(H18<>"",H18*I18,0)'
PS_F_N18 = '=C18'
PS_F_O18 = '=D18'
PS_F_P18 = '=IF(N18<>"",N18*O18,0)'
PS_F_S18 = '=IF(T5<>"",C18,"")'
...
PS_F_E25 = '=IF(P3="",0,IF(AND(H7<>"Mark",H7<>"Richard"),ROUND((P3-E18-E19-E20-E22-E23-E33)*Data!K15,0),0))'
PS_F_K25 = '=IF(P5="",0,IF(AND(H7<>"Mark",H7<>"Richard"),ROUND((P5-K18-K19-K20-K22-K23-K33)*Data!K15,0),0))'
PS_F_P25 = '=IF(P7="",0,IF(AND(H7<>"Mark",H7<>"Richard"),ROUND((P7-P18-P19-P20-P22-P23-P33)*Data!K15,0),0))'
